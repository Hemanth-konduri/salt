...
const CONTACT_CHANNELS = [
  {
    ...
    detail: "Reach out for private dinners, intimate celebrations, and curated evenings.",
  },
  {
    title: "General Enquiries",
    value: "hello@saltkitchen.in",
    detail: "For collaborations, timings, menu questions, and all general requests.",
  },
  {
    title: "Visit Salt",
    value: "Rajahmundry, Andhra Pradesh",
    detail: "A modern dining room shaped for warm service and slower nights.",
  },
];
      ...
      >
        <div
          ...
          style={{
            ...
            backgroundImage:
              "linear-gradient(90deg, rgba(9,11,13,0.82) 0%, rgba(9,11,13,0.52) 44%, rgba(9,11,13,0.3) 100%), url('https://images.unsplash.com/photo-1552566626-52f8b828add9?w=1920&q=85')",
        ...
        >
          ...
          >
            ...
            >
              ...
              before you arrive. We&apos;ll guide you to the right table.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              The form is styled and ready. We can connect it to email or a real
              backend flow next.
            </p>
          </aside>
        </div>
